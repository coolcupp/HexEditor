...
//                    selectedCells.clear();
//
//                    // Заполнение выделенных ячеек на основе начальной и конечной точек
//                    if (startRow != -1 && endRow != -1) {
//                        if (startRow <= endRow) {
//                            // Выделение от startRow до endRow
//                            for (int r = startRow; r <= endRow; r++) {
//                                int start = (r == startRow) ? startCol : 2; // Начало от startCol на первой строке, иначе с колонки 2
//                                int end = (r == endRow) ? endCol : getColumnCount() - 1; // Конец на endCol на последней строке, иначе до последнего столбца
